...
# --- SERVO SETUP (UPDATED FROM REFERENCE) ---
...
def activate_scissor():
    ...
    # Repeat the 50 -> 70 -> 100 sequence 2 times
    for _ in range(2):
        servo.angle = 50
        sleep(1)
...
while True:
        ...
        if conf > min_thresh:
            ...
            if classname.lower() == 'apple':
                ...
                if pixel_diameter > 0:
                    ...
                    # --- TARGET CHECK & SCISSOR EXECUTION ---
    ...
    # Optional: Draw the target area on the frame for visual debugging
