...
# FOCAL_LENGTH needs to be calibrated for your specific camera and resolution!
# Calibration formula: FOCAL_LENGTH = (Pixel Width * Known Distance) / Real Width
# Example: If a 7cm apple placed 50cm away is 84 pixels wide: (84 * 50) / 7 = 600
